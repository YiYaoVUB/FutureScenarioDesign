...
do
	for gcm in ${gcms[@]}
	do 
		for file in $ghm/$gcm/historical/"*historical_histsoc*potevap*";
		do outfile=""
		outfile=$outfile$ghm/$gcm/historical/$ghm"_"$gcm"_historical_1996_2014.nc"
		cdo selyear,1996/2014 $file $outfile;
		mv $outfile /data/brussel/vo/000/bvo00012/vsc10154/scenarios_design/PPET_data/
		done
		
		for file in $ghm/$gcm/future/"*ssp126_2015soc_default*potevap*";
		do outfile=""
		...
		for file in $ghm/$gcm/future/"*ssp370_2015soc_default*potevap*";
		do outfile=""
		...
		for file in $ghm/$gcm/future/"*ssp585_2015soc_default*potevap*";
		do outfile=""
...
cd /data/brussel/vo/000/bvo00012/vsc10154/scenarios_design/PPET_data/PET
